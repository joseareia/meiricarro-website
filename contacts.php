...
<html lang="pt" dir="ltr">
    ...
    <body data-barba="wrapper">
        ...
        <main data-barba="container" data-barba-namespace="contacts-section">
            <!-- Begin of navigation -->
            <div class="navbar">
                <div class="container">
                    <div class="row p-3">
                        ...
                        <div class="col d-flex flex-row-reverse align-items-center">
                            <div class="nav-itens">
                                <ul>
                                    ...
                                    <li>
                                        <a href="/contacts.php" class="active">Contactos</a>
                                    </li>
                                    <li>
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-md-6 ml-5 animate-this">
                            <h1 class="text-white font-weight-bold" id="hero-title">Quer entrar em contacto connosco?</h1>
